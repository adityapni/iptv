...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  String getUrlFormat(String url){
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Expanded(
                                              flex: 1,
                                              child: Text(
                                                'We do not give or provide subscriptions, we are only a Player media player Get login data from any service provider iptv',
                                                style: Get.textTheme.bodyMedium!.copyWith(
                                                  color: Colors.white70,
                                                ),
                                              ),
